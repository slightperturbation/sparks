...
#
#  On Windows, need to copy the DLL from 
#

SET(ASSIMP "assimp")
#SET(CEMSIM_DEFAULT_PATH "C:/libs")
...
FIND_PATH(ASSIMP_INCLUDE_DIR NAMES assimp/Importer.hpp
  ...
  ${CEMSIM_DEFAULT_PATH}/assimp/include
  ENV CPATH
  /usr/include
  /usr/local/include
  /opt/local/include
...
FIND_LIBRARY(LIBASSIMP
  ...
  PATHS
  ${ASSIMP_DEPS_LIB_DIR}
  ${PROJECT_SOURCE_DIR}/ext/assimp/lib/x64
  ${CEMSIM_DEFAULT_PATH}/assimp/lib/x64
  ENV LD_LIBRARY_PATH
  ENV LIBRARY_PATH
  /usr/lib
  /usr/local/lib
