...
void main()
{
    ...
    float scale = 1.0 / u_targetSizeInPixels[1];
    ...
    f_blurTexCoords[ 3] = f_texCoord + vec2(-4*scale, 0.0);
    f_blurTexCoords[ 4] = f_texCoord + vec2(-3*scale, 0.0);
    f_blurTexCoords[ 5] = f_texCoord + vec2(-2*scale, 0.0);
    f_blurTexCoords[ 6] = f_texCoord + vec2(-1*scale, 0.0);
    f_blurTexCoords[ 7] = f_texCoord + vec2( 1*scale, 0.0);
    f_blurTexCoords[ 8] = f_texCoord + vec2( 2*scale, 0.0);
    f_blurTexCoords[ 9] = f_texCoord + vec2( 3*scale, 0.0);
    f_blurTexCoords[10] = f_texCoord + vec2( 4*scale, 0.0);
    f_blurTexCoords[11] = f_texCoord + vec2( 5*scale, 0.0);
    f_blurTexCoords[12] = f_texCoord + vec2( 6*scale, 0.0);
    f_blurTexCoords[13] = f_texCoord + vec2( 7*scale, 0.0);
